...
### Task 10: `Account.tsx` - Abo-Bereich

**Files:**
- Modify: `frontend/src/pages/Account.tsx`

- [ ] **Step 1: Neuen Abschnitt ergänzen**

In `frontend/src/pages/Account.tsx`: neue Komponente `BillingSection`
vor `export default function Account()` einfügen, und im JSX von
`Account()` direkt nach `<PageHeader title="Account" />` (vor dem
bestehenden Kontotyp-Block) einbinden:
...
function BillingSection() {
  ...
  const coachTiers: { key: "starter" | "pro" | "business"; label: string }[] = [
    { key: "starter", label: "Starter (bis 5 Klienten)" },
    { key: "pro", label: "Pro (bis 20 Klienten)" },
    { key: "business", label: "Business (unbegrenzt)" },
  ];

  return (
    <div className="rounded-xl border border-white/5 bg-surface p-4">
      <h2 className="mb-1 text-lg font-semibold text-white">Abo</h2>

      {hasSubscription ? (
        <div className="space-y-3">
          <p className="text-sm text-slate-400">
            Aktueller Plan: <span className="text-white">{user.subscription_tier}</span> (
            {user.subscription_status === "trialing" ? "Testphase" : "aktiv"})
          </p>
          <button
        ...
        <div className="space-y-3">
          <p className="text-sm text-slate-400">Kein aktives Abo - wähle eine Staffel:</p>
        ...
        <div className="space-y-3">
          <p className="text-sm text-slate-400">
            Kostenlose Check-ins genutzt: {user.free_checkins_used} / 2
          </p>
          <button
...
git commit -m "feat: add billing section to Account page"
```
